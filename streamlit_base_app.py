...
# Vectorizer
tweet_cv = open('vect.pkl', 'rb')
tweet_cv = joblib.load(tweet_cv) # loading your vectorizer from the pkl file
...
def main():
	...
	st.subheader("Classification model which determines the writer's sentiment towards climate change")
	...
	if selection == "Prediction":
		st.info("Predicting sentiment based with the aid of a Multiclass Logistic Regression Model")
